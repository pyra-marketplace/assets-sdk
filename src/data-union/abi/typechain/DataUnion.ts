...
export interface DataUnionInterface extends utils.Interface {
  functions: {
    ...
    "closeWithSig(bytes32,(address,uint8,bytes32,bytes32,uint256))": FunctionFragment;
    ...
    "getUnionAsset(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "closeWithSig",
    values: [BytesLike, IDataMonetizer.EIP712SignatureStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getUnionAsset",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  getEvent(nameOrSignatureOrTopic: "UnionClosed"): EventFragment;
}
...
export interface UnionClosedEventObject {
  assetId: string;
  operator: string;
  closeAt: BigNumber;
}
export type UnionClosedEvent = TypedEvent<
  [string, string, BigNumber],
  UnionClosedEventObject
>;

export type UnionClosedEventFilter = TypedEventFilter<UnionClosedEvent>;

export interface DataUnion extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DataUnionInterface;
  ...
  functions: {
    ...
    getUnionAsset(
      assetId: BytesLike,
      overrides?: CallOverrides
    ): Promise<[IDataUnion.UnionAssetStructOutput]>;
  ...
  callStatic: {
    ...
    close(assetId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "UnionClosed(bytes32,address,uint256)"(
      assetId?: null,
      operator?: null,
      closeAt?: null
    ): UnionClosedEventFilter;
    UnionClosed(
      assetId?: null,
      operator?: null,
      closeAt?: null
